...
Within the Okta administration dashboard, navigate to Applications > Applications, and click the "Create App Integration" button. Select "OIDC" as the sign-in method, and "Web application" for the application type.
    ...
    ![Create an app registration](../images/okta-sso/okta_create_app_registration.png)
    ...
    ![Web app integration](../images/okta-sso/okta_web_app_integration.png   )
    ...
    ![Okta integration parameters](../images/okta-sso/okta_integration_parameters.png)
...
![NetBox Okta login form](../images/okta-sso/netbox_okta_login.png)
...
![Okta login portal](../images/okta-sso/okta_login_portal.png)
